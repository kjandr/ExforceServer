...
function serializeMcconf_old(conf, signature) {
    ...
    writeFloat32Auto(conf.foc_motor_flux_linkage);  // Korrigiert: cparts zu parts und onf zu conf
    ...
    for (let i = 0; i < 3; i++) writeFloat32Auto(conf.foc_offsets_current[i]);
