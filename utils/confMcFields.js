...
const METADATA = {
    ...
    si_battery_cells:       { type: "int", min: 10, max: 14 },
    foc_current_ki:         { type: "double", scale: 1, suffix: "", min: 0, max: 100000, decimals: 2 },
    foc_current_kp:         { type: "double", scale: 1, suffix: "", min: 0, max: 100000, decimals: 4 },
    ...
    l_max_erpm:             { type: "double", scale: 1, suffix: "", min: 0, max: 200000, decimals: 2 },
    ...
    foc_observer_gain:      { type: "double", scale: 0.000001, suffix: "", min: 0, max: 20000000000.0, decimals: 2 },
